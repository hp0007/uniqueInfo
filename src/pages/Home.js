    ...
    newArri: [
      {
        ...
        subtitle: " Intel Core i3-1005G1 10th Gen 14-inch FHD",
        path: pc_1,
        price: "Rs.29,000",
      },
      {
        id: 2,
        name: "HP Notebook",
        subtitle: "Pentium Gold 6405U Processor Entry Level 15.6-inch FHD",
        path: pc_2,
        price: "Rs.37,550",
      },
      {
        ...
        subtitle: "13-inch 10th-Generation Intel Core i3 Processor",
        path: pc_3,
        price: "Rs.82,545",
      },
      {
        id: 4,
        name: "Lenovo IdeaPad",
        subtitle: "Slim 3i Intel Celeron N4020 15.6-inch HD Thin",
        path: pc_4,
        price: "Rs.35,400",
      },
      {
        id: 5,
        name: "Lenovo Ideapad",
        subtitle: "ntel Core i3 7th Gen 15.6 inch Full HD Thin",
        path: pc_5,
        price: "Rs.31,200",
      },
      {
      ...
      {
        id: 7,
        name: "HP Pavilion 11th",
        subtitle: "Core i5 Thin & Light 14-Inch FHD Laptop",
        path: pc_7,
        price: "Rs.45,240",
      },
      {
    ...
    <>
          ...
          <div className="row" style={{ overflow: "hidden" }}>
            <Fade left>
              <div className="col-12 col-sm-12 col-md-12 col-lg-6 start">
                ...
                <p>
                  All-New MacBook Pro Features an Immersive 16-Inch Retina
                  Display, Up to 80 Percent Faster Performance and a New Magic
                  Keyboard{" "}
                </p>
      ...
      <div className="categories">
        <div className="container-fluid">
          <Heading
            title="Categories"
            subTitle="Don’t Miss Out On All"
            color="#fff"
          />
        </div>
            ...
            <Zoom right>
              <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                <SimpleCard
                  icon={cpu}
                  title="CPU"
                  subTitle="New assembled and old"
                />
              </div>
              <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                <SimpleCard
            ...
            <Zoom left>
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                <SimpleCard
                  ...
                  subTitle="With very good condition"
                />
              </div>
            </Zoom>
          </div>
      ...
      <div className="new-arrive">
        <div className="container-fluid">
          <Heading
            title="New Arrivals"
            subTitle="We’re crushing on new arrivals + 30% off all full price!"
            color="#000"
          />
        </div>
        <div className="container-fluid">
      ...
      <div className="best-offer">
        <div className="container-fluid">
          <Heading
            ...
            subTitle="Flash Sale! 30% off tonight"
            color="#000"
          />
        </div>
        <div className="container-fluid">
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6">
              ...
              <div className="overlay">
                <Rotate>
                  ...
                  <p>
                    With Ryzen or intel processer with AMD 8GB highspeed
                    Graphics Card{" "}
                  </p>
                </Rotate>
              </div>
      ...
      <div className="explore-top">
        <div className="container-fluid">
          <Heading
            ...
            subTitle="Save up to 20% with top brands"
            color="#000"
          />
        </div>
        <div className="container">
